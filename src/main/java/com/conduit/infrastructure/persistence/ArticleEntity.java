...
public class ArticleEntity {
    ...
    static ArticleEntity fromDomain(Article article) { return new ArticleEntity(article); }

    Article toDomain() {
        return new Article(id, authorId, slug, title, description, body,
                tags.stream().map(Tag::new).toList(), createdAt, updatedAt);
    }
