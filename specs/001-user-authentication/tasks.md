...
- [X] T009 Implement the Spring Data JPA user repository, Hibernate entity, and persistence mapping in `src/main/java/com/conduit/infrastructure/user/persistence/SpringDataUserRepository.java`, `src/main/java/com/conduit/infrastructure/user/persistence/UserEntity.java`, and `src/main/java/com/conduit/infrastructure/user/persistence/UserRepositoryAdapter.java`
- [X] T010 Implement Argon2id hashing and password verification without logging raw credentials in `src/main/java/com/conduit/infrastructure/user/security/Argon2PasswordHasher.java`
- [X] T011 Implement JWT signing and verification from an external required secret in `src/main/java/com/conduit/infrastructure/user/security/JwtTokenService.java`
- [X] T012 Implement `Authorization: Token <jwt>` parsing and authenticated identity propagation in `src/main/java/com/conduit/interfaces/rest/shared/TokenAuthenticationFilter.java`
- [X] T013 Implement shared JSON error mapping for 401, 409, and 422 responses in `src/main/java/com/conduit/interfaces/rest/shared/ApiErrorHandler.java`
...
- [X] T016 [US1] Implement registration request/response DTOs and the User response mapper in `src/main/java/com/conduit/interfaces/rest/user/UserResponseMapper.java`
...
- [X] T018 [US1] Implement the anonymous registration route with HTTP 201, 409, 422, and `Content-Type` contract mapping in `src/main/java/com/conduit/interfaces/rest/user/UserController.java`
...
- [X] T023 [US2] Add the login route and response mapping to `src/main/java/com/conduit/interfaces/rest/user/UserController.java`
...
- [X] T028 [US3] Add the authenticated `GET /api/user` route and 401 mapping to `src/main/java/com/conduit/interfaces/rest/user/UserController.java`
...
- [X] T031 [US4] Implement update request validation for email, username, password, bio, image, and nullable semantics in `src/main/java/com/conduit/interfaces/rest/user/UserController.java`
...
- [X] T033 [US4] Add the authenticated `PUT /api/user` route and response/status mapping to `src/main/java/com/conduit/interfaces/rest/user/UserController.java`
- [X] T034 [US4] Ensure persistence mapping never exposes passwordHash through serializers or logs in `src/main/java/com/conduit/infrastructure/user/persistence/UserEntity.java` and `src/main/java/com/conduit/interfaces/rest/user/UserResponseMapper.java`
...
- [X] T036 [P] Add fail-fast startup integration tests for missing JWT secret and database URL in `src/test/java/com/conduit/interfaces/rest/shared/RequiredConfigurationStartupTest.java`
...
- [X] T045 Add fail-fast startup integration tests for missing `JWT_SECRET` and `DATABASE_URL` in `src/test/java/com/conduit/interfaces/rest/shared/RequiredConfigurationStartupTest.java` per Constitution IV
